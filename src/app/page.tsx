...
export default function HomePage() {
  ...
  const stats = [
    { value: '5', label: 'Training Days', icon: Calendar },
    { value: '6', label: 'Diverse Fields', icon: Lightbulb },
    { value: '10', label: 'Teams', icon: Users },
    { value: '$3500', label: 'In Prizes', icon: Award },
  ];
  ...
  const features = [
    {
      icon: Lightbulb,
      title: 'Innovation',
      description: 'Encouraging creative thinking and developing innovative solutions',
    },
    {
      icon: Target,
      title: 'Leadership',
      description: 'Building leadership capabilities in Syrian youth',
    },
    {
      icon: Rocket,
      title: 'Sustainability',
      description: 'Focusing on sustainable projects with long-term impact',
    },
    {
      icon: Heart,
      title: 'Collaboration',
      description: 'Promoting teamwork and knowledge exchange',
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeIn">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-8 max-w-xl">
                An annual event that brings together creative Syrian youth to launch 
                ideas and projects that reflect their vision for a more innovative 
            ...
            <div className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
                ...
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-r from-primary-50 to-accent-50 border border-primary-100">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Next Event</h4>
                    <p className="text-gray-600">First Edition 2025</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="section-title">Building Tomorrow Together</h2>
            <p className="section-subtitle max-w-2xl mx-auto">
              We aspire to create a generation of Syrian leaders capable of 
              innovation and bringing about positive change.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-primary-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-primary-100 text-lg mb-8">
            Join Syria Vision and be part of the change. Your ideas can shape the future.
          </p>
